...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink flex flex-col justify-between selection:bg-brand selection:text-on-brand font-sans">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-canvas/85 border-b border-line">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <motion.div
            ...
            onClick={scrollToTop}
          >
            <div className="w-9 h-9 rounded-lg bg-brand flex items-center justify-center font-bold text-canvas text-xl shadow-lg shadow-brand/20">
              M
            </div>
          ...
          >
            ...
            <button
              ...
              className="px-4 sm:px-5 py-2.5 rounded-full bg-brand hover:bg-brand-hover text-on-brand transition-all text-xs font-bold uppercase tracking-wider shadow-lg shadow-brand/20 cursor-pointer flex items-center gap-2"
            >
              Let&apos;s Talk
        ...
        <section className="relative pt-16 pb-20 px-6 max-w-7xl mx-auto overflow-hidden">
          ...
          >
            <div className="text-center max-w-4xl mx-auto space-y-6">
              ...
              <motion.p
                variants={itemVariants}
                className="text-lg md:text-xl text-ink-muted max-w-3xl mx-auto leading-relaxed font-normal"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PORTFOLIO_DATA.map((item) => (
              <motion.div
                ...
                className="p-6 md:p-8 rounded-2xl bg-surface border border-line hover:border-brand transition-all flex flex-col justify-between group shadow-lg"
              >
          ...
          <div className="rounded-3xl bg-gradient-to-r from-surface-2 via-surface to-surface-2 border border-brand/40 p-8 md:p-14 relative overflow-hidden shadow-2xl text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex-shrink-0 w-full md:w-auto space-y-3">
              <a
                ...
                className="w-full sm:w-auto px-8 py-5 rounded-2xl bg-brand hover:bg-brand-hover text-on-brand font-bold text-sm tracking-wide uppercase transition-all shadow-xl shadow-brand/25 flex items-center justify-center gap-3 cursor-pointer group"
              >
      ...
      {/* 7. Footer */}
      <footer className="border-t border-line bg-canvas py-12 px-6">
